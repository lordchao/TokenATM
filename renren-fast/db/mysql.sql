...
CREATE TABLE `schedule_job` (
  ...
  `status` tinyint(4) DEFAULT NULL COMMENT '任务状态  0：正常  1：Stop',
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES (11, 6, 'Stop', NULL, 'sys:schedule:pause', 2, NULL, 0);
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES (14, 6, 'Logs', NULL, 'sys:schedule:log', 2, NULL, 0);
